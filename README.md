...
- Eğer GhostGate ağından **sadece tek bir kişi** sınıfta yoklamaya dahil olmuşsa, ağdaki diğer herkes (iOS/iPhone veya Bilgisayar kullanıcıları) web arayüzü üzerinden o yoklamaya **uzaktan** katılabilir.
- Sınıftaki arkadaşınız yoklamaya girdiğinde, sizin için de kapı açılmış olur!

### Akıllı Ağ (Mesh Network)
Sistem tamamen yardımlaşma üzerine kuruludur. Bir kişi "Altın Anahtarı" (yoklama şifresini) bulduğunda, bu bilgi GhostGate ağındaki diğer kullanıcılarla otomatik olarak paylaşılır. Size sadece web portalından veya uygulamadan onay vermek kalır.

### Yoklama Başlatıldı Bildirimi
GhostGate akılli bildirimler özelliği ile sadece sizin kayıtlı olduğunuz derslerin yoklamaların bildirimlerini size gönderir.
...
2.  **Ağa Dahil Olun:** Uygulama veya Web arayüzü üzerinden giriş yapın.
